...
path_list = ['data/ACS1km.csv','data/ACS2km.csv','data/ACS4km.csv']
# dependent variable
Y = 'CS'
# explainatory variables
factors = ['DEM', 'SL', 'AMP', 'AMT', 'AME', 'NDVI','NL','POP','GDP']
...
unit_list=['m', '°', 'mm', '℃', 'mm', 'nW・cm^-2・sr^-1','hm²', 'km²']
...
omgd.scale_plot(scale_result, size_list=[1000,2000 ,4000], dpi=200, unit='m')
plt.show()
